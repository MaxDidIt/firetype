...
package de.maxdidit.hardware.text.renderer
{
	 ...
	 * @author Max Knoblich
	 */
	public class SingleTwoColorGlyphRenderer extends HardwareTextRenderer implements IHardwareTextRenderer
	{
		/////////////////////// 
		// Constants 
		/////////////////////// 
		...
		public function SingleTwoColorGlyphRenderer($context3d:Context3D)
		{
			super($context3d)
		}
