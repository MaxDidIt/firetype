package de.maxdidit.hardware.font
{
	...
	public class HardwareFontDemo extends Sprite
	{
		...
		private function handleContextCreated(e:Event):void
		{
			...
			hardwareParser.loadFont("COUR.TTF").addEventListener(FontEvent.FONT_PARSED, handleBaseFontParsed)
			...
			hardwareParser.loadFont("CONSOLA.TTF").addEventListener(FontEvent.FONT_PARSED, handleHighlightFontParsed);
