package de.maxdidit.hardware.font 
{
	 ...
	 * @author Max Knoblich
	 */
	public class FiretypeBenchmark1B extends Sprite
	{
		...
		public function FiretypeBenchmark1B() 
		{
			// stage properties 
			...
			_textField1.cacheAsBitmap = true;
			...
			_textField2.cacheAsBitmap = true;
			...
			_textField3.cacheAsBitmap = true;
			...
			_textField4.cacheAsBitmap = true;
