package de.maxdidit.hardware.font
{
	...
	public class FiretypeDemo extends Sprite
	{
		...
		{	
			...
			hardwareText.text += "12/8 1/3 á â à Â <format features='" + FeatureTag.STANDARD_LIGATURES.tag +", " + FeatureTag.REQUIRED_LIGATURES.tag + "'>f fi <format color=0xFFFF0000>ffi</format></format> 臥虎藏龍 <format scale=3 vertexDistance=2000>B80</format>\n\n" + //
